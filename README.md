...
| `analyze*.py`, `audit.py` | Trial counts, decay, look-ahead screen, leakage audit |
...
python3 panel.py                     # fetch and split the NASDAQ panel
...
python3 reanalyze.py books && python3 closure.py
python3 figures.py
```
